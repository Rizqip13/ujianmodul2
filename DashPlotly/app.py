...
engine=create_engine("mysql+mysqlconnector://root:pelangi123@localhost/ujiantitanic?host=localhost?port3306&auth_plugin=mysql_native_password")
conn=engine.connect()
...
app.title='Rizqi Putra M' # set web title
